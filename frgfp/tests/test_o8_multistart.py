...
def run_builtin_multistart():
    """Run the built-in multistart over 50 perturbed initial guesses."""
    ...
    return solver.multistart_optimize(
...
def test_o8_multistart_benchmark(benchmark):
    """
    Benchmark the built-in multistart and verify that each converged result
    matches ``o8_fp.dat`` within a relative tolerance.
    """
